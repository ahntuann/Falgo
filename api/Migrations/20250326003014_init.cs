    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogForbiddenWord", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestRegistions", x => new { x.Id, x.ContestId });
                    table.ForeignKey(
                        name: "FK_ContestRegistions_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestRegistions_Contests_ContestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogBookmark", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BlogBookmark_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BlogBookmark_Blogs_BlogID",
                        column: x => x.BlogID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestCaseStatuses", x => x.TestCaseId);
                    table.ForeignKey(
                        name: "FK_TestCaseStatuses_Submissions_SubmissionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4b896ee8-832b-4470-a6df-59ff5d697c48", null, "Guest", "GUEST" },
                    { "e07f4af4-90a1-42b2-a5cb-d0d37d4b4d4c", null, "Admin", "ADMIN" },
                    { "e29aef0d-533d-4752-9c53-4ff3efabb047", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogBookmark_BlogID",
                table: "BlogBookmark",
                column: "BlogID");

            migrationBuilder.CreateIndex(
                name: "IX_BlogBookmark_UserID",
                table: "BlogBookmark",
                column: "UserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestRegistions_AppUserId",
                table: "ContestRegistions",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ContestRegistions_ContestId",
                table: "ContestRegistions",
                column: "ContestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestCaseStatuses_SubmissionId",
